...
# Preload Starknet Devnet for faster tests, skip already satisfied logs.
RUN pip3 install "starknet-devnet==$STARKNET_DEVNET" | grep --invert-match 'Requirement already satisfied:'
